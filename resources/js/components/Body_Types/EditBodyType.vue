    ...
    <div class="container pt-5 pb-lg-4 mt-5 mb-sm-2">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7 mb-5">
                <h1 class="h2 text-light">Edit Body Type</h1>
                <form class="needs-validation pb-4" @submit.prevent="modifierbodytype">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-12 mb-3">
                            <label class="form-label text-light" for="account-password-confirm">Type Image</label>
...
const fetchBodytype = async () => {
    await axios.get(`http://localhost:8000/api/bodytypes/${route.params.id}`).then((res)=> {

        bodytype.value = res.data;
        })
...
const modifierbodytype = () => {
    axios.put(`http://localhost:8000/api/bodytypes/${route.params.id}`, bodytype
        .value)

        .then(() => {
            router.push('/listBodyTypes')
        })
        .catch(error => {
